package org.commonjava.freemaker.freeki.util;
...
public final class UrlUtils
{
    ...
    public static String buildUrl( final boolean validate, final String baseUrl, final String... parts )
        throws MalformedURLException
    {
        return buildUrl( validate, baseUrl, null, parts );
    }

    public static String buildUrl( final boolean validate, final String baseUrl, final Map<String, String> params,
                                   final String... parts )
        throws MalformedURLException
    {
